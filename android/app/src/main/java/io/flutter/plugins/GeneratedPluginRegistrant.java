...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.pollfish.flutterpollfish.FlutterPollfishPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin flutter_pollfish, com.pollfish.flutterpollfish.FlutterPollfishPlugin", e);
    }
    try {
